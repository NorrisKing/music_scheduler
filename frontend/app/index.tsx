    ...
    <>
      ...
      <View className="flex-1 bg-background px-5">
        ...
        <View className="pt-10 pb-8 items-center">
          ...
          <Text className="text-foreground text-2xl font-black tracking-tight">Spotify Scheduler</Text>
          <Text className="mt-2 text-center text-sm text-muted-foreground leading-relaxed px-4">
            Lancez automatiquement vos playlists{'\n'}à l'heure que vous choisissez
          </Text>
        </View>
